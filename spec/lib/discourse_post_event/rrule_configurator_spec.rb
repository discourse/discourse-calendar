  ...
  describe ".rule" do
    context "with every_day recurrence" do
      it "generates the correct rule" do
        rule = RRuleConfigurator.rule(recurrence: "every_day", starts_at: time, timezone: timezone)
    ...
    context "with every_month recurrence" do
      it "generates the correct rule for the second Wednesday of the month" do
        ...
        rule =
          RRuleConfigurator.rule(recurrence: "every_month", starts_at: time, timezone: timezone)
      ...
      it "generates the correct rule for the first Monday of the month" do
        ...
        rule = RRuleConfigurator.rule(recurrence: "every_month", starts_at: first_monday, timezone:)
      ...
      it "generates the correct rule for the last day of the month" do
        ...
        rule =
          RRuleConfigurator.rule(recurrence: "every_month", starts_at: last_day, timezone: timezone)
    ...
    context "with every_weekday recurrence" do
      it "generates the correct rule" do
        rule =
          RRuleConfigurator.rule(recurrence: "every_weekday", starts_at: time, timezone: timezone)
    ...
    context "with every_two_weeks recurrence" do
      it "generates the correct rule" do
        rule =
          RRuleConfigurator.rule(recurrence: "every_two_weeks", starts_at: time, timezone: timezone)
    ...
    context "with every_four_weeks recurrence" do
      it "generates the correct rule" do
        rule = RRuleConfigurator.rule(recurrence: "every_four_weeks", starts_at: time, timezone:)
    ...
    context "with every_week recurrence (default)" do
      it "generates the correct rule" do
        rule = RRuleConfigurator.rule(recurrence: "every_week", starts_at: time, timezone: timezone)
      ...
      it "uses the day of the week from starts_at" do
        ...
        rule =
          RRuleConfigurator.rule(recurrence: "every_week", starts_at: monday, timezone: timezone)
    ...
    context "with different timezone" do
      ...
      it "correctly formats the rule" do
        rule = RRuleConfigurator.rule(recurrence: "every_week", starts_at: time, timezone: timezone)
        expect(rule).to eq("FREQ=WEEKLY;BYDAY=WE")
      end

      it "correctly formats the UNTIL parameter with timezone" do
        recurrence_until = Time.utc(2021, 8, 12, 16, 32)
        rule =
          RRuleConfigurator.rule(
            recurrence: "every_day",
