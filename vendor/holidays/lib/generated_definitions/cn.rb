...
module Holidays
  ...
  module CN # :nodoc:
    ...
    def self.holidays_by_month
      {
                0 => [{:function => "cn_new_lunar_day(year)", :function_arguments => [:year], :observed => "to_monday_if_sunday(date)", :observed_arguments => [:date], :name => "Lunar New Year's Day", :regions => [:cn]},
            {:function => "cn_new_lunar_day(year)", :function_arguments => [:year], :function_modifier => 1, :observed => "to_monday_if_sunday(date)", :observed_arguments => [:date], :name => "The second day of Lunar New Year", :regions => [:cn]},
            {:function => "cn_new_lunar_day(year)", :function_arguments => [:year], :function_modifier => 2, :observed => "to_weekday_if_boxing_weekend(date)", :observed_arguments => [:date], :name => "The third day of Lunar New Year", :regions => [:cn]},
            {:function => "cn_new_lunar_day(year)", :function_arguments => [:year], :function_modifier => 3, :observed => "to_weekday_if_boxing_weekend(date)", :observed_arguments => [:date], :name => "The fourth day of Lunar New Year", :regions => [:cn]},
            {:function => "cn_new_lunar_day(year)", :function_arguments => [:year], :function_modifier => 4, :observed => "to_weekday_if_boxing_weekend(date)", :observed_arguments => [:date], :name => "The fifth day of Lunar New Year", :regions => [:cn]},
            {:function => "cn_new_lunar_day(year)", :function_arguments => [:year], :function_modifier => 5, :observed => "to_weekday_if_boxing_weekend(date)", :observed_arguments => [:date], :name => "The sixth day of Lunar New Year", :regions => [:cn]},
            {:function => "cn_new_lunar_day(year)", :function_arguments => [:year], :function_modifier => 6, :observed => "to_weekday_if_boxing_weekend(date)", :observed_arguments => [:date], :name => "The seventh day of Lunar New Year", :regions => [:cn]},
            {:function => "cn_dragon_boat_day(year)", :function_arguments => [:year], :observed => "to_monday_if_sunday(date)", :observed_arguments => [:date], :name => "Dragon Boat Festival", :regions => [:cn]}],
      1 => [{:mday => 1, :observed => "to_monday_if_sunday(date)", :observed_arguments => [:date], :name => "New Year's Day", :regions => [:cn]}],
      4 => [{:mday => 4, :observed => "to_monday_if_sunday(date)", :observed_arguments => [:date], :name => "Ching Ming Festival", :regions => [:cn]}],
      5 => [{:mday => 1, :observed => "to_monday_if_sunday(date)", :observed_arguments => [:date], :name => "Labour Day", :regions => [:cn]}],
      9 => [{:mday => 15, :observed => "to_monday_if_sunday(date)", :observed_arguments => [:date], :name => "Mid-Autumn Festival", :regions => [:cn]}],
      10 => [{:mday => 1, :observed => "to_monday_if_sunday(date)", :observed_arguments => [:date], :name => "National Day", :regions => [:cn]}]
      }
    end
...
"cn_dragon_boat_day(year)" => Proc.new { |year|
case year
when 2024
  Date.civil(year, 6, 10)
when 2025
  Date.civil(year, 5, 31)
when 2026
  Date.civil(year, 6, 19)
when 2027
  Date.civil(year, 6, 9)
when 2028
  Date.civil(year, 5, 28)
when 2029
  Date.civil(year, 6, 16)
when 2030
  Date.civil(year, 6, 5)
when 2031
  Date.civil(year, 6, 24)
when 2032
  Date.civil(year, 6, 12)
when 2033
  Date.civil(year, 6, 1)
when 2034
  Date.civil(year, 6, 20)
when 2035
  Date.civil(year, 6, 10)
when 2036
  Date.civil(year, 5, 30)
when 2037
  Date.civil(year, 6, 18)
when 2038
  Date.civil(year, 6, 7)
when 2039
  Date.civil(year, 5, 27)
when 2040
  Date.civil(year, 6, 14)
end
},
